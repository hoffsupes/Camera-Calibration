...
function [Pbestnew,final_inliers] = do_RANSAC_alternate(X,c,P,k,eps,thresh,inlier_ratio) %% X: All the 3D data points, c: All the 2D data points, P: Probability that at least one of the subsets contains no outliers, k: size of subset, eps: fraction of outliers
